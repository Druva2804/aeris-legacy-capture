...
const ClosingStatement: React.FC = () => {
  return (
    <section className="py-24 bg-[url('https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=2038')] bg-cover bg-fixed bg-center">
      <div className="bg-aeris-overlay/70 absolute inset-0"></div>
      <div className="container relative z-10 mx-auto px-6 md:px-10 text-center">
        <div className="max-w-3xl mx-auto text-white">
          ...
          <Button className="bg-white/80 hover:bg-white text-aeris-charcoal px-8 py-6">
